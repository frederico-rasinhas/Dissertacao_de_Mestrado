...
# Load data from rosbag + LIDAR CSV
loader = DataLoader(
    bag_path="",
    lidar_csv_path=""
)
...
# Instantiate ESKF with IMU + Odom + LiDAR
eskf = ErrorStateKalmanFilter(imuModel, odoSensor, lidarSensor)
...
# === Set LiDAR Sensor Noise (optional override) ===
# lidarSensor.R = np.eye(7) * 3e-4**2
